<div class="headerBack" style="background: linear-gradient(90deg, #9ebd13 0%, #008552 100%);">
  <div class="page-content miHeader">
    <div class="miTitulo">
      ...
      <h2>Registrar PMVA</h2>
    </div>
    <p class="txtBg">Registrar PMVA</p>
  </div>
</div>
  ...
  <main class="page-content">
    <div class="container-fluid">
      <section class="agregarUsuarios">
        ...
        <form class="ui form attached segment agregarPmva" action="<?php echo base_url(); ?>GECOA/agregarPmva" method="post">
