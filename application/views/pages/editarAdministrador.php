  ...
  <main class="page-content">
    <div class="container-fluid">
      <section class="agregarUsuarios">
        ...
        <form class="ui form attached segment agregarAdministrador" id="miform" action="<?php echo base_url(); ?>GECOA/editarUsuario" method="post">
          ...
          <div class="field">
            ...
            <input type="email" name="txt_usuario" disabled id="txt_usuario" value="<?php echo $txt_usuario; ?>">
          </div>
