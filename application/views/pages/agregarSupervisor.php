<div class="headerBack" style="background: linear-gradient(90deg, #9ebd13 0%, #008552 100%);">
  <div class="page-content miHeader">
    ...
    <p class="txtBg">Registrar Supervisor</p>
  </div>
</div>
...
<main class="page-content">
  <div class="container-fluid">
    <section class="agregarUsuarios">
      <h3 class="ui top grey inverted attached header">SUPERVISOR</h3>
      <form class="ui form attached segment agregarSupervisor" action="<?php echo base_url(); ?>GECOA/agregarSupervisor" method="post">
        ...
        <div class="field">
          <div class="ui checkbox">
            <input type="checkbox" name="esAdministrador" <?php echo $esAdministrador; ?>>
