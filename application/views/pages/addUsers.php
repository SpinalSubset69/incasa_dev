<div class="headerBack" style="background: linear-gradient(90deg, rgba(26, 43, 64,0.9) 100% ,rgb(24,30,51) 0%);">
  <div class="page-content miHeader">
    ...
    <p class="txtBg">Agregar Usuario</p>
  </div>
</div>
...
<main class="page-content">
  <div class="container-fluid">
    <section class="addTruck">
      <h3 class="ui top grey inverted attached header">USUARIO</h3>
      <form class="ui form attached segment agregarSupervisor" action="<?php echo base_url(); ?>Pedrera/addUsers" method="post">
        ...
        <div class="three fields">
          <div class="field">
            <label>Usuario:</label>
            <input type="text" name="txt_user" placeholder="Usuario" id="txt_user" value="<?php echo $user ?>">
          </div>
          <div class="field">
            <label>Contraseña:</label>
            <input type="password" name="txt_password" placeholder="Contraseña" id="txt_password" value="<?php echo $password; ?>">
          </div>
          <div class="field">
            <label>Tipo de usuario:</label>
            <div class="ui selection dropdown txt_tipoUsuario">
              <input type="hidden" name="txt_tipoUsuario">
              <i class="dropdown icon"></i>
        ...
        fields: {
          ...
          txt_Pedrera     : {
            rules: [
              {
                type: 'empty',
                prompt: 'Ingresa la pedrera donde labora el usuario'
              }
            ]
          }
        },
