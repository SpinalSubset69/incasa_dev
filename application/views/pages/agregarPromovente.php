<div class="headerBack" style="background: linear-gradient(90deg, #9ebd13 0%, #008552 100%);">
  <div class="page-content miHeader">
    <div class="miTitulo">
      ...
      <h2>Registrar Promovente</h2>
    </div>
    <p class="txtBg">Registrar Promovente</p>
  </div>
</div>
      ...
      <form class="ui form attached segment agregarPromovente" action="<?php echo base_url(); ?>GECOA/agregarPromovente" method="post">
        <div class="three fields">
          <div class="required field">
            ...
            <input type="text" name="txt_nombre" placeholder="Nombre/Razón Social" id="txt_nombre" value="<?php echo $txt_nombre; ?>">
          </div>
          <div class="required field">
            <label>Abreviatura:</label>
            <input type="text" name="txt_display" placeholder="Abreviatura" id="txt_display" value="<?php echo $txt_display; ?>">
          </div>
          <div class="required field">
            <label>RFC:</label>
            <input type="text" name="txt_rfc" placeholder="RFC" id="txt_rfc" value="<?php echo $txt_rfc; ?>">
          </div>
        </div>
        ...
        <div class="field">
          ...
          <input type="text" name="txt_pagweb" id="txt_pagweb" value="<?php echo $txt_pagweb; ?>">
        </div>
        <div class="field">
        ...
        <a class="ui secondary right floated button" name="button" href="<?php echo base_url(); ?>GECOA/"><i class="arrow left icon"></i> Regresar</a>
        <button type="button"  class="ui clear right floated button " id="btn_limpiarPromovente" name="button"><i class="eraser icon"></i> Limpiar</button>
